      ...
      <DialogContent className="w-[95vw] sm:w-[90vw] max-w-4xl max-h-[85vh] sm:max-h-[85vh]">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm">
            Essential information for using DeltaEdge effectively and responsibly
          </DialogDescription>
        </DialogHeader>
          ...
          <ScrollArea className="h-[50vh] sm:h-[60vh] mt-3 sm:mt-4 pr-2 sm:pr-4">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3 ml-7">
                    <div>
                      <h4 className="font-medium">DeltaEdge is a tool, not a crystal ball</h4>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">What Makes DeltaEdge Different</h3>
            ...
            <TabsContent value="limitations" className="space-y-4">
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Critical: Understanding these limitations is essential before using DeltaEdge
                </AlertDescription>
              </Alert>
            ...
            {/* Section 3: How to Use DeltaEdge */}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ol className="space-y-3 ml-7 text-sm list-decimal">
                    <li><strong>Cross-reference multiple sources</strong> - Don't rely solely on DeltaEdge</li>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p>DeltaEdge provides analysis tools only and is not liable for any betting losses, legal issues, or addiction-related problems.</p>
