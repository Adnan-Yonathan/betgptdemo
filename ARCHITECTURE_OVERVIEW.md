...
| **The Odds API** | Betting lines, multi-bookmaker | Free tier | 500/month | 🎯 BETTING |
...
│  │  • betting_odds (from Odds API + BDL)                    │  │
│  │  • sports_scores (from OpenAI/BDL)                       │  │
│  │  • api_source_log (monitoring)                           │  │
│  │  • betting_odds_fetch_log (Odds API automation)          │  │
│  └─────────────────────────────────────────────────────────┘  │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────┐  │
│  │  Cron Jobs:                                              │  │
